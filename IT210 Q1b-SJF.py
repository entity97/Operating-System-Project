...
###                         IT 210 Project                                          ###
###     Question 1  CPU Scheduling Algorithms b) SJF                                ###
#######################################################################################
...
#Here we are using the .sort() method with argument lambda x[1] to sort the processes in order from smallest to largest
...
for i in range(1, num_processes):
    ...
    total_time = waiting_time + processes[i][1]
